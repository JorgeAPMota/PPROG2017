...
public class Hostel extends Alojamento {
     ...
     *
     * @param nome - Atributo nome de objectos de Hostel que é enviado para a
     * super classe Alojamento
     * @param endereco - Atributo endereço de objectos de Hostel que é enviado
     * para a super classe Alojamento
     * @param nif - Atributo nif de objectos de Hostel
     * @param servicoTransfer - Boolean logo será true se tiver este serviço, ou
     * false se não tiver
     * @param horarioRecepcao - Atributo correspondente ao horário da recepção
     * do objecto hostel
     */
    ...
    /**
     * Método de acesso para obter o horario de recepçao de uma instância de
     * Hostel
     *
     ...
     *
     * @return - string com o conteudo do toString da super classe, e horario da
     * recepcao do hostel
     */
    @Override
     ...
     * (incluindo no horario da recepcao) à EntidadecomNif. Caso contrário
     * retorna false.
     */
    @Override
